import { studentSessionColumns } from './student-session-columns'
...
export function StudentSessionList() {
  const { sessions, loading, fetchSessions } = useStudentSessions()
      ...
      <div className="container mx-auto py-10">
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <p className="text-lg">Chargement de vos sessions...</p>
          </div>
        </div>
      </div>
    )
      ...
      <div className="container mx-auto space-y-6 p-4">
        <div className="flex flex-col space-y-2">
          ...
          <p className="text-muted-foreground">
            Consultez vos sessions de formation
          </p>
        </div>
        ...
        <div className="flex min-h-[400px] flex-col items-center justify-center rounded-lg border border-dashed p-8 text-center animate-in fade-in-50">
          <div className="mx-auto flex max-w-[420px] flex-col items-center justify-center text-center">
            ...
            <p className="mb-4 mt-2 text-sm text-muted-foreground">
              ...
              Contactez l'administration pour vous inscrire à une formation.
            </p>
          </div>
        </div>
      </div>
